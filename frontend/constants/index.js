const site_data_default = {
  ...
  features: [
    {
      id: 2,
      title: 'just copy paste skills required',
      subtitle: 'Get the server side compatible components in one place',
      text: "We know it's frustrating to find an UI kit with all the supported components for next.js 14 and then find out that each element does not work with server side, so here you will find 150+ building blocks for free. And there are many more on the way!",
      img: '/media/feature_2.jpg',
    },
    {
      id: 3,
  ...
  faq: {
    ...
    faq_items: [
      {
        id: 1,
        question: 'What is Inators UI? lorem ipsum',
        answer:
    ...
    subtitle:
      "Here are some of our FAQs. If you have any other questions you'd like answered please feel free to contact me.",
  },
};
